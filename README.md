...
| Basket API | [![Basket API](https://github.com/sughosneo/eShopOnContainers/workflows/basket-api-build/badge.svg)](https://github.com/sughosneo/eShopOnContainers/actions?query=workflow%3A%22basket-api-build%22) | Shopping Aggregator (Mobile) | [![Mobile Shopping Aggregator](https://msftdevtools.visualstudio.com/eShopOnContainers/_apis/build/status/microservices/mobile-shopping-agg?branchName=dev)](https://msftdevtools.visualstudio.com/eShopOnContainers/_build/latest?definitionId=204&branchName=dev) |
| Catalog API | [![Catalog API](https://github.com/sughosneo/eShopOnContainers/workflows/catalog-api-build/badge.svg)](https://github.com/sughosneo/eShopOnContainers/actions?query=workflow%3A%22catalog-api-build%22) | Web Client (MVC) | [![WebMVC Client](https://msftdevtools.visualstudio.com/eShopOnContainers/_apis/build/status/microservices/webmvc?branchName=dev)](https://msftdevtools.visualstudio.com/eShopOnContainers/_build/latest?definitionId=209&branchName=dev) |
